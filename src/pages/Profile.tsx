  ...
  useEffect(() => {
    ...
    const loadStats = async () => {
      try {
        ...
        // MMR chart: per-mode from game_players.mmr, pick mode with most data
        ...
        // Sort each mode oldest→newest, re-index
        ...
        // Pick mode with most data points (prefer 2v2 > 3v3 > 1v1 as tiebreaker)
