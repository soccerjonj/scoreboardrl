...
7. division_change: ONLY set to "up" or "down" if the screenshot contains a large, explicit full-screen or banner-style rank promotion/demotion animation — text like "RANK UP", "RANKED UP", "DIVISION UP", "PROMOTED", "DEMOTED", or a prominent upward/downward arrow overlay that indicates the player's rank tier or division has changed. Do NOT use: the win/loss result, MMR gain/loss numbers, individual player rank badges in the scoreboard rows, or a "CURRENT TIER" label at the bottom — those are always present and are NOT division changes. The vast majority of games (even competitive wins) do NOT result in a rank change. Default to "none" in all cases of doubt — it is always better to miss a rank change than to falsely report one.
